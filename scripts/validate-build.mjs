...
if (manifest.version !== "1.2.0" || pkg.version !== manifest.version || versions[manifest.version] !== manifest.minAppVersion) failures.push("Release versions are inconsistent.");
