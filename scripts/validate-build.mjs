...
if (manifest.version !== "1.0.0" || pkg.version !== manifest.version || versions[manifest.version] !== manifest.minAppVersion) failures.push("Release versions are inconsistent.");
